...
:: Add "Download to Current Folder" entry to the context menu for directories
echo Adding "Download to Current Folder" with an icon to the context menu...
...
echo "Download to Current Folder" entry successfully added with an icon.
pause
